...
R3 & \textbf{Test of H2(b) --- Does τ-recalibration recover F1?} & 15/18 region-optimal τ ≠ 0.5 across 3 benchmarks(flood/damage/wildfire);up to +0.235 F1 recovered;magnitude is hazard-specific \\
...
\textbf{HLS Burn-Scars (4 fire-season events, 2018--2021 CONUS).} We trained a
...
benchmarks and ≥ 18 real events, \textbf{15 of 18 region-optimal thresholds
...
\tightlist
\item
  \textbf{Sen1Floods11} {[}Bonafilia 2020{]} --- 446 hand-labelled chips across 11 regions,
