...
covers \cite{reichstein2025earlywarning}; the wildfire arm of our study sits
alongside a parallel Nature Communications result showing global,
satellite-driven fire-activity prediction is itself now data-driven and
operational at scale \cite{digiuseppe2025fireactivity}.
...
tasks \cite{wu2025skysense} do not obviate this test: scale and modality
