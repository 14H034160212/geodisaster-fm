...
$\neq$ 0.5} but on the opposite side of the default (Fig.~3).
...
Fig.~4 for the v1$\leftrightarrow$v2 comparison): the v1 PPO was an
...
\textbf{LOEO-v2 result (Table 1, Fig.~4).}
...
\textbf{The per-event picture under 20-seed LOEO (Fig.~4, Supplementary Table 1).}
...
Both fail (Fig.~5) --- and the \emph{way} they fail is diagnostic. Saerens EM diverges
